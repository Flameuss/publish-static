...
alter table "bazil_luccme_cr_fcplusnz"
...
update "bazil_luccme_cr_fcplusnz"
...
from (select s.id,
      ...
      from "bazil_luccme_cr_fcplusnz" s,
           "regions" b
      where st_intersects(s.geom, b.geom)
        and st_within(s.geom, b.geom)) s_intersets
where "bazil_luccme_cr_fcplusnz".id = s_intersets.id
  and "bazil_luccme_cr_fcplusnz"."region_id" is null;
...
create index "bazil_luccme_cr_fcplusnz_region_id_idx" on "bazil_luccme_cr_fcplusnz" ("region_id");
